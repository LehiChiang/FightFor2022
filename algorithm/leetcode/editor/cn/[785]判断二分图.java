package leetcode.editor.cn;//存在一个 无向图 ，图中有 n 个节点。其中每个节点都有一个介于 0 到 n - 1 之间的唯一编号。给你一个二维数组 graph ，其中 graph[u]
...
class isBipartiteSolution {
    ...
    public static void main(String[] args) {
        isBipartiteSolution solution = new isBipartiteSolution();
